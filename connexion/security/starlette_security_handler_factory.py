...
logger = logging.getLogger('connexion.security.starlette_security_handler_factory')

client = httpx.AsyncClient(limits=httpx.Limits(max_connections=100))


class StarletteSecurityHandlerFactory(AbstractAsyncSecurityHandlerFactory):
